...
class BookForm(forms.ModelForm):
    class Meta:
        model=models.Book
        fields=['name','SrNo','author','category']
class IssuedBookForm(forms.Form):
    #to_field_name value will be stored when form is submitted.....__str__ method of book model will be shown there in html
    SrNo2=forms.ModelChoiceField(queryset=models.Book.objects.all(),empty_label="Name and SrNo", to_field_name="SrNo",label='Name and SrNo')
